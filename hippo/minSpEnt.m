function [vals sorted] = minSpEnt(pos,u,s,v,spT,spId,spf,vals,sh)
...
for i = 1:size(vals,3)%range
    ...
    for k = 1:2
        ...
        for i = 1:size(vals,2)
            subplot(size(vals,2),numDisp,numDisp*(i-1)+1);imagesc(squeeze(vals(k,i,:,:)));axis off;ylabel(num2str(spSort(i)));
