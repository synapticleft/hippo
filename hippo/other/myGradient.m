function varargout = myGradient(f,varargin)
...
%   $Revision: 5.17.4.5 $  $Date: 2006/06/20 20:09:24 $
...
for k = 1:ndim
   ...
   if n > 2
      ...
      g(2:n-1,:) = myDiff(f(3:n,:),f(1:n-2,:))/2;
   end
