...
%YY=sum(X.*X)'/(T);
%Y = permute(Y,[2 3 1]);
[A, W, F, S, a, B, x0, V0, loglik] = kalmanMLE(Y,C,diag(R),A,Q,x0,P0);
net.A = A;net.W = W; net.F = F; net.S = S; net.a = a;net.B = B;net.x0 = x0; net.V0 = V0; net.loglik = loglik;
%     %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%   else
%     % AR1 model
%     LM=[];
