function [xValsCorr,yValsCorr,xValsErr,yValsErr]=GExploreTrajectories(filename,ses,Nsaturate)
...
jX=data(:,10);     % joystick x coord 15
jY=data(:,11);     % joystick y coord 16
musc1=data(:,17);  % emg1
musc2=data(:,18);  % emg2
...
for ic=1:6
    ...
    ctrs{1}=linspace(xlims(1),xlims(2),40);ctrs{2}=linspace(ylims(1),ylims(2),40);%-2.5:5:147.5;
