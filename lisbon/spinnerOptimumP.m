function [VValues,QValues,PValues,traj,acts, score] = spinnerOptimumP(fname,wavenums,VValues,QValues)
...
temperature = .01;%temperature for soft-max action selection (larger than .0015 explodes to inf)
