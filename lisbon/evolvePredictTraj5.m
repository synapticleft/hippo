function [stats, yOrig, yFits] = evolvePredictTraj5(fn,lambda,sigma,inds,timePast,offSet,trialHist,diff,startAlign,finalChoice) %sessNorm,
% variant of evolvePredictTraj3 that separates out sessions based on
% eventual left vs. right choice
