% RobustICA algorithm for independent component analysis (Release 2 - February 16, 2010)
% --------------------------------------------------------------------------------------
%
...
%                             the algorithm calls the two functions below.
%
...
%     
%    If you use this package to generate results in your publications, please cite reference [1].
%
%
% COMPATIBILITY:
% 
%    The package has been tested on Matlab 6.5, 7.3, 7.5 and 7.9. Hyperlinks in the help section of
%    some files do not work properly under version 6.5.
%
%
% UPDATES:
% 
