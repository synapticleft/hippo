...
nruns = 100             % number of Monte Carlo runs ('nruns = 1000' in Fig. 3 of [1])
...
nmet = length(methods);
par_prewhi = [0, 1, 0, 1]           % prewhitening: 0 = no
par_deftype = ['o', 'o', 'o', 'o']  % deflation: 'o'rthogonalization or 'r'egression
par_dimred = zeros(1, nmet)         % dimensionality reduction: 0 = no
