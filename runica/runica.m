...
DEFAULT_STOP         = 0.0000001;  % stop training if weight changes below this
...
DEFAULT_BLOCK        = min(floor(5*log(frames)),floor(0.3*frames)); % heuristic 
                                  % - may need adjustment!
% Extended-ICA option:
...
if strcmp(sphering,'on'), %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  ...
  %figure;subplot(221);plot(data');
  %subplot(222);plot(data(1,:),data(2,:));axis tight;
  data = (sphere*data);      % actually decorrelate the electrode signals
%subplot(223);plot(data');subplot(224);plot(data(1,:),data(2,:));axis tight;
...
%
  ...
  while step < maxsteps, %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for t=1:block:lastt, %%%%%%%%% ICA Training Block %%%%%%%%%%%%%%%%%%%
      ...
      %weights = weights + lrate*(BI-(y*u'))*weights;
       %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
      else % extended-ICA
...
%
      ...
      oldweights = weights;
      iweights = pinv(weights)*10;
%      subplot(224);plot(data(1,:),data(2,:));hold on;scatter(iweights(1,:),iweights(2,:),'r','filled');hold off;axis tight;drawnow;
%
