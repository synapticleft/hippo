...
% system with control inputs and without an affine term in the measurement equation.
%
function [A, W, F, S, x0, V0, B] = kalmanMStep2(Z, xsmooth, Vsmooth, VVsmooth, diagS, diagW, U)
